 ...
 * </p>
 * Leap array使用滑动窗口算法统计数据，
 * 每个bucket桶跨越了windowLengthInMs样本窗口的时间长度，总的时间跨度是intervalInMs
 * 总的bucket桶的数量，sampleCount = intervalInMs / windowLengthInMs
 *
...
public abstract class LeapArray<T> {
    ...
    // 长度为 sampleCount
    // 注意，这里的泛型T在ArrayMetric的LeapArray属性中，实际为MetricBucket
    // 含义为 样本窗口中的数据类型
